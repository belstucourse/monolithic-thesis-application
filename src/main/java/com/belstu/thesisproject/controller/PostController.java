...
public class PostController {
    ...
    @GetMapping("/{id}/posts")
    public List<PostDto> getPostByAuthorId(@PathVariable final String id,
    ...
    @GetMapping("/posts")
    public Page<PostDto> getAllPosts(@PageableDefault(sort = {"id"}, direction = DESC) Pageable pageable) {
